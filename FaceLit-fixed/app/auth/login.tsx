    ...
    <AuthCard scrollable={false}>
      ...
      <View style={styles.checkRow}>
        ...
        <View style={styles.checkLabelRow}>
          ...
          <NavLink href="/auth/privacy-notice" label="aviso de privacidad" />
        </View>
      </View>
      ...
      <View style={styles.links}>
        <NavLink href="/auth/password-recovery" label="¿Olvidaste tu contraseña?" />
        <View style={styles.registerRow}>
          <Text style={styles.linkText}>¿No tienes cuenta? </Text>
          <NavLink href="/auth/register" label="Regístrate aquí" />
        </View>
      </View>
    </AuthCard>
  );
