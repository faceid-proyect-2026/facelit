          ...
          <View style={[
            ...
            <View style={[s.importantBox, { backgroundColor: importantBg, borderColor: theme.primary + '40' }]}>
              ...
              <Text style={[s.importantText, { color: text }]}>
                <Text style={[s.importantBold, { color: theme.primary }]}>
                  {t('rights.importantLabel')}
                </Text>
...
const s = StyleSheet.create({
  ...
  card: {
    width: '100%', maxWidth: CARD_MAX, borderRadius: 26, borderWidth: 1,
  ...
  iconCircle: {
    ...
    shadowColor: '#65B361', shadowOffset: { width: 0, height: 4 },
